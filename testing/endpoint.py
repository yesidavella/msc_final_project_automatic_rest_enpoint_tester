...
class DynamicTester:
    ...
    def basic_get(id):
        ...
        status_code = 200
        answ = "All 24 process carried out completely 99 - request: {}".format(str(request))
        ...
        logging.info("Finishing call on /basicget/<id>. Printing 55request: {}".format(str(request)))
